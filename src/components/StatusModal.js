            ...
            <View style={styles.modalContainer}>
                <View style={styles.modalContent}>
                    <Text style={styles.modalText}>
                        Não foi possivel se conectar com Broker HiveMQ
                        Verifique sua conexão e credentials
                    </Text>
...
const styles = StyleSheet.create({
    ...
    modalText: { color: '#fff', marginBottom: 25, textAlign: 'center', fontSize: 16 },

    btnRetry: { backgroundColor: '#27AE60', padding: 15, borderRadius: 12, width: '100%', marginBottom: 12 },

    btnLater: { backgroundColor: '#444', padding: 15, borderRadius: 12, width: '100%' },
